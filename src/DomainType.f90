...
type, public :: domain_type
  ...
  integer             :: itime = 0         ! current integer time step of model run. 0 means not initialized yet
...
contains   
  ...
  subroutine InitDefault(this)
    ...
    this%curr_datetime  = huge(1.d0)      
    this%itime          = 0               ! means time_init has not run
    this%ntime          = huge(1) 
